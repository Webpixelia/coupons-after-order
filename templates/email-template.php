...
// Coupon
$coupon_font_color = isset($_GET['wccao_coupons_after_order_coupon_font_color']) ? sanitize_hex_color(wp_unslash($_GET['wccao_coupons_after_order_coupon_font_color'])) : get_option('wccao_coupons_after_order_coupon_font_color');
$coupon_bg_color = isset($_GET['wccao_coupons_after_order_coupon_bg_color']) ? sanitize_hex_color(wp_unslash($_GET['wccao_coupons_after_order_coupon_bg_color'])) : get_option('wccao_coupons_after_order_coupon_bg_color');
...
<head>
	...
	<style>
		...
		ul .prefix-coupon {
			...
			background: <?php echo esc_attr($coupon_bg_color); ?>;
			color: <?php echo esc_attr($coupon_font_color); ?>;
			text-align: center;
			break-inside: avoid-column;
		}

		ul .prefix-coupon:not(:last-child) {
			margin-bottom: 1em;
		}
